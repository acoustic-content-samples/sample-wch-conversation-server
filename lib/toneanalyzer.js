...
const toneanalyzerservice = appEnv.credentials.getService('wch-toneanalyzer');
const ToneAnalyzerV3 = require('watson-developer-cloud/tone-analyzer/v3');

const toneanalyzer = (appEnv.settings.wch_toneanalyzer.enabled) ? new ToneAnalyzerV3({
