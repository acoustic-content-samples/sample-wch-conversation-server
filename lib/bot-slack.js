    ...
    middleware.interpret(bot, message, function(err) {
      ...
      if (err) {
        ...
        then(responses => {
          ...
          then(([parsedSearchResult, parsedAttachmentsResult]) => {
            return transformToSlackMessage({watsonData:watsonData, searchResult: parsedSearchResult, attachmentsResult: parsedAttachmentsResult});
          }).
          catch(errHandler).
