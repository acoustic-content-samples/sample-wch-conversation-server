...
const transformToSlackMessage = function (resultSet) {
  return new Promise((resolve, reject) => {
    ...
    if(searchResult.numFound > 0) {
      ...
      resolve({text: `${doc.elements.text.value} ${icon}`, attachments: attachments, icon_url:'https://my6.digitalexperience.ibm.com/8f032d79-a358-4825-af1b-d6cc169692c6/dxdam/8c/8c290073-6365-4400-8dce-40e286667e50/MrWatson.PNG'});
    } else {
