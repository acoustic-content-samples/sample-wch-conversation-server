...
const errHandler = ({err, bot, message, reason}) => {debug(err.stack ? err.stack : err); bot.reply(message, `This question gave me a headache :face_with_head_bandage: Please give me some minutes to recover. But if you are in a hurry I will try again to find an answer for you. *Reason:* ${reason}`);};
