...
const botOptions = {
  ...
  access_token: fbConfig.credentials.key,
  verify_token: fbConfig.credentials.verificationtoken,
...
module.exports = function (middleware) {
  ...
  controller.hears(['^(?!\\.\\.\\.).*'], ['message_received'], function(bot, message) {
    ...
    debug('BOT %o', bot);
    bot.reply(message, "Analyzing...");

    middleware.interpret(bot, message, function(err) {

      bot.reply(message, "Conversational Test Reply");
      // if (err) {
      //   debug('Error ', err);
