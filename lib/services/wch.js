...
const apiurl = url.parse(chatbotconfig.credentials.apiurl);
const wchAuthoring = new WchConnector({
  tenantid: chatbotconfig.credentials.hubid,
  endpoint: 'authoring',
  baseUrl: chatbotconfig.credentials.apiurl,
  credentials: {
...
module.exports.hosturl = `${apiurl.protocol}//${apiurl.host}`;
module.exports.caching = appEnv.settings.wch_config.caching;
